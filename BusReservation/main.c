...
{
    int PassNo;    // busNumberSeatNumber.
    char name[20]; // busName.
    struct BinarySearchTree *left, *right;
};

BST *root = NULL;
int cost(BST *r);                        // This calculates the cost.
void status();                           // This shows bus and seats status
...
int busSeat[32][9] = {0};
void redColor()
{ // For printing the message in a redColor
    printf("\033[1;31m");
}
void resetColor()
{ // Reset the old color of console
    printf("\033[0m");
}
    ...
    while (presentnode)
    {
        if (presentnode->PassNo == s)
        {
            *custIDmatched = 1;
            ...
            printf("\n||              TICKET COST: R.%d                             ||", cost(presentnode));
            printf("\n-----------------------------------------------------------------");
            resetColor();
            getch();
            return r;
...
void busLists()
{
    ...
    printf("-----------------------------------------------------------------------------------------");
    resetColor();
    printf("\n1\tGangaTravels         \tDharan to Kavre       \tR.70   \t\t07:00  AM");
    printf("\n2\tPhaphara Travels     \tKavre To Dharan       \tR.55    \t\t01:30  PM");
    printf("\n3\tShiv Ganga Travels   \tAllahabad To Gorakhpur\tR.40    \t\t03:50  PM");
    printf("\n4\tSuper Deluxe         \tPokhara To Benigha    \tR.70    \t\t01:00  AM");
    printf("\n5\tSai Baba Travels     \tMaitidevi To Janakpur \tR.55    \t\t12:05  AM");
    printf("\n6\tShine On Travels     \tMadhubani to Patna    \tR.40    \t\t09:30  AM");
    printf("\n7\tMayur Travels        \tPatna To Gaya         \tR.70   \t\t11:00  PM");
    printf("\n8\tRajjo Travels       \tBegusarai To Patna     \tR.55    \t\t08:15  AM");
    printf("\n9\tShree Travels        \tGaya To Chhapra       \tR.40    \t\t04:00  PM");
    printf("\n");
